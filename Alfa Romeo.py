...
def navigate_and_extract(driver, wait, xpath):
    try:
        ...
        print(f"Failed to navigate and extract document URL: {e}")
        return None
...
def run_alfa_romeo_script(excel_path):
    ...
    years_models_documents = {
            ...
            'models': {
                ...
                'GIULIA': {
                    ...
                    'documents': {
                        ...
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][4]',
            ...
            'models': {
                ...
                'GIULIA': {
                    ...
                    'documents': {
                        ...
                        'AEB': '//*[@data-automationid="ListCell"][4]',
                        'AHL': '//*[@data-automationid="ListCell"][5]',
                        'APA': '//*[@data-automationid="ListCell"][6]',
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][1]',
                        'BUC': '//*[@data-automationid="ListCell"][7]',
                        'LKA': '//*[@data-automationid="ListCell"][8]'
                    }
                },
                'STELVIO': {
                    ...
                    'documents': {
                        ...
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][8]',
                        'BUC': '//*[@data-automationid="ListCell"][9]',
                        'LKA': '//*[@data-automationid="ListCell"][10]'
                    }
                }
            }
        },
        '2019': {
            ...
            'models': {
                '4C COUPE': {
                    ...
                    'documents': {
                        'APA': '//*[@data-automationid="ListCell"][2]',
                        'BUC': '//*[@data-automationid="ListCell"][3]'
                    }
                },
                'GIULIA': {
                    'model_page_xpath': '//*[@data-automationid="ListCell"][2]',
                    'documents': {
                        ...
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][6]',
                        'BUC': '//*[@data-automationid="ListCell"][7]',
                        'LKA': '//*[@data-automationid="ListCell"][8]'
                    }
                },
        ...
        '2021': {
            'year_page_xpath': '//*[@data-automationid="ListCell"][7]',
            'models': {
                '4C COUPE': {
                    'model_page_xpath': '//*[@data-automationid="ListCell"][1]',
                    'documents': {
            ...
            'models': {
                'GIULIA': {
                    ...
                    'documents': {
                        ...
                        'AEB': '//*[@data-automationid="ListCell"][3]',
                        'AHL': '//*[@data-automationid="ListCell"][7]',
                        'APA': '//*[@data-automationid="ListCell"][8]',
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][4]',
                        'BUC': '//*[@data-automationid="ListCell"][9]',
                        'LKA': '//*[@data-automationid="ListCell"][5]'
                    }
                ...
                'STELVIO': {
                    ...
                    'documents': {
                        ...
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][4]',
                        'BUC': '//*[@data-automationid="ListCell"][8]',
                        'LKA': '//*[@data-automationid="ListCell"][9]'
                    }
                }
            }
        },
            ...
            'models': {
                'GIULIA': {
                    ...
                    'documents': {
                        ...
                        'AHL': '//*[@data-automationid="ListCell"][1]',
                        'APA': '//*[@data-automationid="ListCell"][2]',
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][6]',
                        'BUC': '//*[@data-automationid="ListCell"][7]',
                        'LKA': '//*[@data-automationid="ListCell"][8]'
                ...
                'STELVIO': {
                    'model_page_xpath': '//*[@data-automationid="ListCell"][2]',
                    'documents': {
                        'ACC': '//*[@data-automationid="ListCell"][5]',
                        'AEB': '//*[@data-automationid="ListCell"][6]',
                        'AHL': '//*[@data-automationid="ListCell"][7]',
                        'APA': '//*[@data-automationid="ListCell"][1]',
                        'BSW/RCTW': '//*[@data-automationid="ListCell"][2]',
                        'BUC': '//*[@data-automationid="ListCell"][3]',
                        'LKA': '//*[@data-automationid="ListCell"][8]'
                    }
                }
        ...
        '2024': {
            'year_page_xpath': '//*[@data-automationid="ListCell"][10]',
            'models': {
                'GIULIA': {
                    'model_page_xpath': '//*[@data-automationid="ListCell"][1]',
                    'documents': {
    ...
    try:
        ...
        for year, data in years_models_documents.items():
            ...
            driver.back()
            WebDriverWait(driver, 10).until(
                EC.visibility_of_element_located((By.XPATH, '//*[@data-automationid="ListCell"][1]'))
            )
    except Exception as e:
